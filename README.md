...
# 📖 Leaderboad <a name="about-project"></a>

This Leaderboard project is based on an online website that allows users to add score

**Leaderboard** In this project, we will built a basic website that allows users to add score and have score list from an API. We achieved that by using JavaScript objects and arrays. We also dynamically modified the DOM and added basic events.
...
- [Live Demo Link]( https://touredri.github.io/Leaderboard/dist/)
...
```sh
  cd my-folder
  git clone git@github.com:touredri/Leaderboard.git
```
